  ...
  return (
    <nav className="glass-panel sticky top-0 z-50 px-6 py-4 flex justify-between items-center mb-8 mx-4 mt-4">
      <Link to="/" className="flex items-center space-x-2 text-primary-500 hover:text-primary-400 transition-colors">
        ...
        <span className="text-xl font-bold tracking-wider text-gray-900 dark:text-gray-100 flex items-center">
          Dev<span className="text-primary-500 mr-2">Sight</span>
          <span className="bg-accent-purple/20 text-accent-purple text-xs font-black px-2 py-1 rounded-md uppercase tracking-widest drop-shadow-sm">Admin</span>
        </span>
      </Link>
